      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (result.data.status === 'success') {
            (0, _alert.showAlert)('success', 'successfully loging ✅');
            // go to home page after 1500 milleseconds
...
},{"./alert.js":"alert.js","axios":"../../node_modules/axios/index.js"}],"validationsLogin.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var validateLogin = exports.validateLogin = function validateLogin() {
  var email = document.querySelector('.email');
  var password = document.querySelector('.pass');
  var regEx = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  email.addEventListener('input', function () {
    regEx.test(this.value) ? email.style.borderBottom = '3px solid green' : email.style.borderBottom = '3px solid orange';
  });
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(result);
          if (result.data.status === 'success') {
            (0, _alert.showAlert)('success', 'successfully regiser ✅');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
},{"./alert.js":"alert.js","axios":"../../node_modules/axios/index.js"}],"validationsSignup.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable */
var displayMap = exports.displayMap = function displayMap(locations, map) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 55
    }).setLngLat(loc.coordinates).setHTML("<p style='color:gray; font-size:15px'>Day ".concat(loc.day, ":").concat(loc.description, "</p>")).addTo(map);
  });
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var logoutAct = exports.logoutAct = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          (0, _alert.showAlert)('error', 'No Internet please connect first ');
        case 11:
        case "end":
          return _context.stop();
      }
  ...
  return function logoutAct() {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"accountValidation.js":[function(require,module,exports) {
"use strict";
...
// eslint-disable
var validationProfile = exports.validationProfile = function validationProfile(updateME, email, currentPassword, newPassword, confirmPAssword) {
  // validation for name
  ...
  var regEx = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  email.addEventListener('input', function () {
    regEx.test(this.value) ? email.style.borderBottom = 'solid 2px #28b487' : email.style.borderBottom = 'solid 2px orange';
  });
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51QpCtrK94WdxSBgzMOtBtq4nWNxEbruFa9dyRm7xIwfl6oxWvUVRvek13AL34tMJKu2R8fKNExVJCUe0EnvBwxWF00Q58hfHu2');
...
var _validationsLogin = require("./validationsLogin");
var _signup = require("./signup");
var _validationsSignup = require("./validationsSignup");
var _mapBox = require("./mapBox");
var _logout = require("./logout");
var _accountValidation = require("./accountValidation");
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
// elements
var updateME = document.querySelector('.update-mynameing');
var email = document.querySelector('.update-mymail');
...
var form = document.querySelector('.formloginOrsignup');
var updateData = document.querySelector('.updateData');
var updatePasswords = document.querySelector('.updatePasswords');
var buyBtn = document.querySelector('.inner-link');
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    if (!document.querySelector('#name')) {
      ...
      (0, _signup.signup)(document.querySelector('#name').value, email, password, document.querySelector('#confirmPass').value);
    }
  });
  if (!document.querySelector('#confirmPass') && !updateME) (0, _validationsLogin.validateLogin)();else if (document.querySelector('#confirmPass') && !updateME) (0, _validationsSignup.validationSignup)();
}
var locEle = document.getElementById('map');
if (locEle) {
  var locations = JSON.parse(locEle.dataset.locations);
  mapboxgl.accessToken = 'pk.eyJ1IjoiYW53YXItdGFyZWsxMjMiLCJhIjoiY20zdW1wM2V5MGpkZDJrczUwNHg5enowZiJ9.YR1WGDizc4k24svThskBQQ';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/anwar-tarek123/cm3vpqcgm00e401sd8eha05vb',
    scrollZoom: false
  });
  (0, _mapBox.displayMap)(locations, map);
}
//logout
var outBtn = document.querySelector('.nav__el1');
if (outBtn) {
  outBtn.addEventListener('click', _logout.logoutAct);
}
if (updateME) {
  (0, _accountValidation.validationProfile)(updateME, email, currentPassword, newPassword, confirmPAssword);
}
if (updateData) {
  updateData.addEventListener('submit', function (e) {
    ...
    (0, _settings.updateSettings)('data', form);
  });
}
if (updatePasswords) {
  updatePasswords.addEventListener('submit', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _settings.updateSettings)('password', {
...
},{"./login":"login.js","./validationsLogin":"validationsLogin.js","./signup":"signup.js","./validationsSignup":"validationsSignup.js","./mapBox":"mapBox.js","./logout":"logout.js","./accountValidation":"accountValidation.js","./settings":"settings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
